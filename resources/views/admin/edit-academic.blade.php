        ...
        <div class="row">
            <div class="col-md-3 col-lg-2 px-0">
                <div class="sidebar p-3">
                    ...
                    <nav class="nav flex-column">
                        ...
                        <a class="{{ request()->routeIs('admin.edit-academic') ? 'nav-link active' : 'nav-link' }}" href="#"><i class="fas fa-graduation-cap me-2"></i> Edit Academic</a>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content p-4">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <p class="text-muted mb-0">Academic page editor coming soon.</p>
                        </div>
                    </div>
                </div>
            </div>
